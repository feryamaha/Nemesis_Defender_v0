        ...
        if found_colon {
            match child.kind() {
                ...
                | "class_declaration" => {
                    ...
                    ).with_suggestion("[STOP] Leia .windsurf/rules/typescript-typing-convention.md antes de reescrever. Envolva o case em bloco: case x: { const y = ... }. Consulte: https://biomejs.dev/"));
                    }
                }
                _ => {}
            }
