    ...
    if matches!(node.kind(), "function_declaration" | "arrow_function" | "function_expression" | "method_definition" | "program") {
        ...
        for var in unused {
            violations.push(
                ...
                .with_suggestion("[STOP] Leia .windsurf/rules/typescript-typing-convention.md antes de reescrever. Remova a variável ou prefixe com _ se for intencional. Consulte: https://biomejs.dev/")
            );
        }
    }
