        ...
        if child.kind() == "parenthesized_expression" {
            ...
            for pc in &pcs {
                ...
                if is_constant_literal(text) {
                    ...
                    ).with_suggestion("[STOP] Leia .windsurf/rules/typescript-typing-convention.md antes de reescrever. Substitua por uma condicao que dependa de valores em runtime. Consulte: https://biomejs.dev/"));
                    return;
                }
        ...
        if test_idx + 1 < children.len() {
            ...
            if is_constant_literal(text) && text != "true" {
                ...
                violations.push(Violation::new(
                    ...
                    line, RuleCategory::Correctness,
                ).with_suggestion("[STOP] Leia .windsurf/rules/typescript-typing-convention.md antes de reescrever. Revise a condicao do loop. Consulte: https://biomejs.dev/"));
            }
        }
    }
}
