    ...
    while let Some(p) = parent {
            ...
            || p.kind() == "arrow_function" || p.kind() == "method_definition"
        {
            ...
            if text.contains(": void") {
                ...
                ).with_suggestion("[STOP] Leia .windsurf/rules/typescript-typing-convention.md antes de reescrever. Remova o valor de retorno ou mude o tipo da funcao. Consulte: https://biomejs.dev/"));
            }
            return;
        }
        parent = p.parent();
