        ...
        if child.kind() == "identifier" {
            ...
            if text == "eval" {
                ...
                violations.push(
                    ...
                    .with_suggestion("[STOP] Leia .windsurf/rules/Conformidade.md antes de reescrever. Use funções explícitas. eval() é vetor de code injection. Consulte: https://biomejs.dev/")
                );
                return;
            }
        }
        ...
        if child.kind() == "identifier" {
            ...
            if text == "Function" {
                ...
                violations.push(
                    ...
                    .with_suggestion("[STOP] Leia .windsurf/rules/Conformidade.md antes de reescrever. Use funções explícitas. new Function() é vetor de code injection. Consulte: https://biomejs.dev/")
                );
                return;
            }
        }
